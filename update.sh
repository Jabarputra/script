...
res1() {
    wget https://raw.githubusercontent.com/Jabarputra/script/main/Cdy/menu.zip
    ...
    wget /usr/local/sbin "https://raw.githubusercontent.com/Jabarputra/script/main/Cfg/m-noobz" 
